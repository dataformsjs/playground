...
<html lang="en">
  <head>
    ...
    <style>
            ...
            .alert-danger { background-color:var(--main-color); color:#fff; }
            .alert-info { background-color:var(--lighter-color-2); }
            .alert, table { box-shadow:0 2px 3px 0 rgba(0,0,0,.8); }
            h1 { font-size:2em; }
            h2 { color:var(--main-color); margin-bottom:10px; font-size:1.75em; }
            table.table { text-align:left; width:100%; margin-bottom:40px; border-collapse:collapse; }
            table.table thead { background-color:var(--main-color); color:#fff; }
            .table.table > thead > tr > th { padding:12px 10px; border:1px solid var(--lighter-color-1); }
            .table.table > tbody > tr > td { padding:8px 10px; border:1px solid var(--lighter-color-1); vertical-align:top; }
            .table-striped>tbody>tr:nth-child(odd) { background-color:var(--lighter-color-3); }
